angular.module('ng-terminal-zookeeper', ['vtortola.ng-terminal', 'ng-terminal-zookeeper.command.tools', 'ng-terminal-zookeeper.command.implementations'])
...
.controller('console',['$scope','$ga','commandBroker','$rootScope', function ($scope, $ga, commandBroker, $rootScope) {
    ...
    setTimeout(function () {
        $scope.$broadcast('terminal-output', {
            output: true,
            text: ['Welcome to ZooKeeperM Console',
                   'Thanks to https://github.com/vtortola/ng-terminal-emulator',
                   '',
